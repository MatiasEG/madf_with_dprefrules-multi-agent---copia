		            ...
		            public void windowClosing(WindowEvent e) {
		            	try {
		            		if(scout.isDataSaved()) {
		            			...
		            			JOptionPane.showMessageDialog(null, "Debe guardar los cambios para que se cargue el ejemplo.", "Advertencia", JOptionPane.WARNING_MESSAGE);
		            		}
						} catch (IOException e1) {
